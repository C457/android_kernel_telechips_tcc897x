...
typedef struct	{
	...
	VIOC_MC_DITH_MAT_U		uDITH_MAT0;			// 0x34
	VIOC_MC_DITH_MAT_U		uDITH_MAT1;			// 0x38
	volatile unsigned  int 		reserved0[5]; 			// 0x3C ~4C
	VIOC_MC_OFS_RADDR_U	uOFS_RADDR_Y;			// 0X50
	VIOC_MC_OFS_RADDR_U	uOFS_RADDR_C;			// 0X54
	VIOC_MC_COM_RADDR_U	uCOM_RADDR_Y;			// 0X58
	VIOC_MC_COM_RADDR_U	uCOM_RADDR_C;			// 0X5C
