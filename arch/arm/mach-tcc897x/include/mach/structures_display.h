...
/************************************************************************
*   3.6.6   GRDMA  and VRDMA				(Base Addr = 0x72000400)
*************************************************************************/
typedef	struct
{
	unsigned		FMT		:  5;
...
/************************************************************************
*   3.6.7   Frame Delay				(Base Addr = 0x72003900)
*************************************************************************/
...
typedef	struct _VIOC_FDLY
{
	...
	VIOC_FDLY_DFLT_u	uDFLT;			// 0x10	R/W	0x00000000		Frame Delay Default Color Register
...
/************************************************************************
*   3.6.10   WMIX				(Base Addr = 0x72001800)
*************************************************************************/
