...
#define VIDIOC_USER_SET_VIDEO_MODE					_IOWR ('V', BASE_VIDIOC_PRIVATE+7, int) //for hdmi-in mode selection(video)
#define VIDIOC_USER_GET_VIDEO_MODE					_IOWR ('V', BASE_VIDIOC_PRIVATE+8, int) //for hdmi-in mode selection(video)
#define VIDIOC_USER_SET_HDMI_AUDIO					_IOWR ('V', BASE_VIDIOC_PRIVATE+9, int) //for hdmi-in mode selection(video)
#define VIDIOC_USER_GET_HDMI_AUDIO					_IOWR ('V', BASE_VIDIOC_PRIVATE+10, int) //for hdmi-in mode selection(video)
#endif
