...
#define DCTRL_R2YMD                    28                                // RGB to YCbCr Conversion Option
#define DCTRL_ADVI                     26                                // Advanced interlaced mode
#define DCTRL_656                      24                                // CCIR 656 Mode
#define DCTRL_CKG                      23                                // Clock Gating Enable for Timing Generator
#define DCTRL_SREQ                     22                                // stop request
#define DCTRL_Y2RMD				       20			                     // YUV to RGB converter mode register
#define DCTRL_PXDW                     16                                // PXDW
#define DCTRL_ID                       15                                // Inverted Data Enable
#define DCTRL_IV                       14                                // Inverted Vertical Sync
#define DCTRL_IH                       13                                // Inverted Horizontal Sync
#define DCTRL_IP                       12                                // Inverted Pixel Clock
#define DCTRL_CLEN                     11                                // Clipping Enable
#define DCTRL_R2Y                      10                                // RGB to YCbCr Converter Enable for Output 
#define DCTRL_DP                       9                                 // Double Pixel Data
#define DCTRL_NI                       8                                 // Non-Interlace
#define DCTRL_TV                       7                                 // TV mode 
#define DCTRL_SRST                     6                                 // Device display reset 
