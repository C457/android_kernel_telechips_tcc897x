...
ifeq ($(shell echo $(INCLUDE_LCD_HDMI_1920x720_12_3)), true)
KBUILD_CFLAGS += -DHDMI_1920_720_12_3
KBUILD_CFLAGS += -DINCLUDE_TOUCH_MXT_1189T
endif

ifeq ($(shell echo $(INCLUDE_PRODUCT_LCD_RESOLUTION)),1280x720)
KBUILD_CFLAGS += -DINCLUDE_LCD_RESOLUTION_1280_720
endif

ifeq ($(shell echo $(INCLUDE_LCD_TOUCHKEY)), true)
KBUILD_CFLAGS += -DINCLUDE_LCD_TOUCHKEY
KBUILD_CFLAGS += -DINCLUDE_TOUCH_MXT_1189T
endif
...
ifeq ($(shell echo $(INCLUDE_CURVED_TI_SERDES)), true)
KBUILD_CFLAGS += -DINCLUDE_CURVED_TI_SERDES
endif
