...
#define DWC3_REVISION_280A	0x5533280a
	...
	struct dwc3_host_cap_regs __iomem *cap_regs;
	struct dwc3_host_op_regs __iomem *op_regs;

	struct dwc3_work_data drd_work_data;
};
