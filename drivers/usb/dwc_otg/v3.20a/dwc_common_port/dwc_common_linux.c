...
//#define CONFIG_DBG_MEM_TRACE // for mem alloc/free trace
...
#ifdef CONFIG_DBG_MEM_TRACE
	DWC_DEBUGPL(DBG_MEM_TRACE,"[%s:%d]\x1b[1;31m(DA)-%p\x1b[0m\n", __func__, __LINE__, buf);
#endif
...
#ifdef CONFIG_DBG_MEM_TRACE
	DWC_DEBUGPL(DBG_MEM_TRACE,"[%s:%d]\x1b[1;35m(DAA)-%p\x1b[0m\n", __func__, __LINE__, buf);
#endif
...
#ifdef CONFIG_DBG_MEM_TRACE
	DWC_DEBUGPL(DBG_MEM_TRACE,"[%s:%d]\x1b[1;32m(DF)-%p\x1b[0m\n", __func__, __LINE__, virt_addr);
#endif
}
...
#ifdef CONFIG_DBG_MEM_TRACE
	DWC_DEBUGPL(DBG_MEM_TRACE,"[%s:%d]\x1b[1;31m(A)-%p\x1b[0m\n", __func__, __LINE__, buf);
#endif
...
{
	void *buf = kzalloc(size, GFP_ATOMIC);

#ifdef CONFIG_DBG_MEM_TRACE
	DWC_DEBUGPL(DBG_MEM_TRACE,"[%s:%d]\x1b[1;35m(AA)-%p\x1b[0m\n", __func__, __LINE__, buf);
#endif
...
void __DWC_FREE(void *mem_ctx, void *addr)
{
	kfree(addr);
#ifdef CONFIG_DBG_MEM_TRACE
	DWC_DEBUGPL(DBG_MEM_TRACE,"[%s:%d]\x1b[1;32m(F)-%p\x1b[0m\n", __func__, __LINE__, addr);
#endif
}
