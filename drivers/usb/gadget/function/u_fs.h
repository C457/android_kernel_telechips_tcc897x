...
extern int functionfs_bind_config(struct usb_composite_dev *cdev,
				   struct usb_configuration *c,
				   struct ffs_data *ffs);
extern int functionfs_bind(struct ffs_data *ffs, struct usb_composite_dev *cdev);
extern void functionfs_unbind(struct ffs_data *ffs);
#endif /* U_FFS_H */
