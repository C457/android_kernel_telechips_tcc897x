...
int mtp_ctrlrequest(struct usb_composite_dev *cdev,
...
EXPORT_SYMBOL_GPL(mtp_ctrlrequest);
...
int __maybe_unused mtp_bind_config(struct usb_configuration *c, bool ptp_config)
{
	struct mtp_dev *dev = _mtp_dev;
	int ret = 0;
...
int __maybe_unused mtp_setup(void)
{
