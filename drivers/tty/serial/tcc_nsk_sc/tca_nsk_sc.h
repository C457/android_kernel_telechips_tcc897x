...
#define HwDMA_CHCTRL_CONT_EN        Hw15           // Issue Continuous Transfer. DMA transfer begins from C_SADR / C_DADR address.
...
#define HwDMA_CHCTRL_IEN_ON          Hw2           // At the same time the FLAG goes to 1, DMA interrupt request is generated
#define HwDMA_CHCTRL_FLAG            Hw3           // W : Clears FLAG to 0, R : Represents that all hop of transfer are fulfilled
...
extern int tca_nsk_sc_send_receive(char *pTxBuf, unsigned uTxBufLen, char *pRxBuf, unsigned *puRxBufLen, unsigned uDirection, unsigned uTimeOut);
