 ...
 * define
 *****************************************************************************/
//static int cec_msgRx(struct cec_device * dev, char *buf, unsigned size,int timeout);
//static int cec_msgTx(struct cec_device * dev, const char *buf, unsigned size, unsigned retry);
...
#if 0
int cec_ctrlSendFrame(struct cec_device * dev, const char *buf, unsigned size, unsigned src, unsigned dst);
#else
