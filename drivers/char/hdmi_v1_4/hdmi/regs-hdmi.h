...
#define PMU_REG(x)                             	(tcc_p2v(0x14400000) + (x))
#endif
...
#elif defined(CONFIG_ARCH_TCC896X)
#define DDICFG_REG(x)				(tcc_p2v(0x12380000) + (x))
#endif
...
#elif defined(CONFIG_ARCH_TCC896X)
#define HDMIDP_HDMI_SSREG(x)        		(tcc_p2v(0x12300000) + (x))
#endif
...
#elif defined(CONFIG_ARCH_TCC896X)
#define HDMIDP_HDMIREG(x)        			(tcc_p2v(0x12310000) + (x))
#endif
//@{
/**
...
#elif defined(CONFIG_ARCH_TCC896X)
#define HDMIDP_AESREG(x)        		(tcc_p2v(0x12320000) + (x))
#endif
...
#elif defined(CONFIG_ARCH_TCC896X)
#define HDMIDP_SPDIFREG(x)        		(tcc_p2v(0x12330000) + (x))
#endif
//@{
/**
...
#elif defined(CONFIG_ARCH_TCC896X)
#define HDMIDP_I2SREG(x)        		(tcc_p2v(0x12340000) + (x))
#endif
//@{
/**
 * @name I2S registers
...
#define HDMIDP_PHYREG(x)        		(tcc_p2v(0x12360000) + (x))
#elif defined(CONFIG_ARCH_TCC897X)
#define HDMIDP_PHYREG(x)        		(tcc_p2v(0x72360000) + (x))
