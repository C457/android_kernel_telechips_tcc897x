...
/* IREQ0 */
	...
	VIOC_IREQ_DummyHandler, 	 	/* VIOC_IREQ_MC0 */
	VIOC_IREQ_DummyHandler, 	 	/* VIOC_IREQ_MC1 */
	VIOC_IREQ_DummyHandler, 	 	/* VIOC_IREQ_MMU */
	VIOC_IREQ_DummyHandler, 	 	/* VIOC_IREQ_DTRC0 */
	VIOC_IREQ_DummyHandler, 	 	/* VIOC_IREQ_DTRC1 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_27 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_FIFO0 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_FIFO1 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_30 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_31 */
/* IREQ0 */
	...
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_41 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_42 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_SC4 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_44 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_VIQE1 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_46 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_RESERVED_47 */
	...
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_WMIX6 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_VIN0 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_VIN1 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_VIN2 */
	VIOC_IREQ_DummyHandler, 		/* VIOC_IREQ_VIN3 */
