...
//+[TCCQB] QuickBoot Booting or Making flag
 ...
 */
//+[TCCQB] To Call device_resume( ) in dpm_resume_noirq()
...
//+[TCCQB] Debug Log Option
#if defined(CONFIG_HIBERNATION) && defined(CONFIG_PM_VERBOSE_DPM_SUSPEND)
