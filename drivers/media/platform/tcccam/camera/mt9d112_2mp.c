...
static int write_regs_mt9d112(const struct sensor_reg reglist[], struct tcc_camera_device * vdev)
{
	int err;
	int err_cnt = 0;	
	int sleep_cnt = 100;
...
static int sensor_open_mt9d112(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	...
	return write_regs_mt9d112(sensor_reg_common_mt9d112[0], vdev);
}

static int sensor_close_mt9d112(struct tcc_camera_device * vdev)
{
...
static int sensor_powerdown_mt9d112(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	#if (1) //20110315 ysseung   supported to sensor stand-by mode.
	sensor_port_enable(vdev->gpio_data.pwd_port);
	sensor_delay(60);
...
static int sensor_preview_mt9d112(struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_common_mt9d112[1], vdev);
}

static int sensor_capture_mt9d112(struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_common_mt9d112[2], vdev);
}

static int sensor_capturecfg_mt9d112(int width, int height, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_zoom_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_autofocus_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_af_mt9d112[val], vdev);
}

static int sensor_effect_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_effect_mt9d112[val], vdev);
}

static int sensor_flip_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_flip_mt9d112[val], vdev);
}

static int sensor_iso_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_iso_mt9d112[val], vdev);
}

static int sensor_me_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_metering_exposure_mt9d112[val], vdev);
}

static int sensor_wb_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_awb_mt9d112[val], vdev);
}

static int sensor_bright_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_brightness_mt9d112[val], vdev);
}

static int sensor_scene_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9d112(sensor_reg_scene_mt9d112[val], vdev);
}

static int sensor_check_esd_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_check_luma_mt9d112(int val, struct tcc_camera_device * vdev)
{
	return 0;
}
...
{
	sensor_info_init_mt9d112(sensor_info);
}
