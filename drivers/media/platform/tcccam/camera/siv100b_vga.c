...
static int write_regs_siv100b(const struct sensor_reg reglist[], struct tcc_camera_device * vdev)
{
	int err;
	int err_cnt = 0;	
...
static int sensor_open_siv100b(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	...
	return write_regs_siv100b(sensor_reg_common_siv100b[0], vdev);
}

static int sensor_close_siv100b(struct tcc_camera_device * vdev)
{
...
static int sensor_powerdown_siv100b(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	sensor_port_disable(vdev->gpio_data.rst_port);
	sensor_port_disable(vdev->gpio_data.pwr_port);
	sensor_port_enable(vdev->gpio_data.pwd_port);
...
static int sensor_preview_siv100b(struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_common_siv100b[1], vdev);
}

static int sensor_capture_siv100b(struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_common_siv100b[2], vdev);
}

static int sensor_capturecfg_siv100b(int width, int height, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_zoom_siv100b(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_autofocus_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_af_siv100b[val], vdev);
}

static int sensor_effect_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_effect_siv100b[val], vdev);
}

static int sensor_flip_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_flip_siv100b[val], vdev);
}

static int sensor_iso_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_iso_siv100b[val], vdev);
}

static int sensor_me_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_metering_exposure_siv100b[val], vdev);
}

static int sensor_wb_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_awb_siv100b[val], vdev);
}

static int sensor_bright_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_brightness_siv100b[val], vdev);
}

static int sensor_scene_siv100b(int val, struct tcc_camera_device * vdev)
{
	return write_regs_siv100b(sensor_reg_scene_siv100b[val], vdev);
}

static int sensor_check_esd_siv100b(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_check_luma_siv100b(int val, struct tcc_camera_device * vdev)
{
	return 0;
}
...
{
	sensor_info_init_siv100b(sensor_info);
}
