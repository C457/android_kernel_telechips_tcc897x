...
static int write_regs_s5k5caga(const struct sensor_reg reglist[], struct tcc_camera_device * vdev)
{
	int err;
	int err_cnt = 0;	
	int sleep_cnt = 100;
...
static int sensor_open_s5k5caga(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	...
	return write_regs_s5k5caga(sensor_reg_common_s5k5caga[0], vdev);
}

static int sensor_close_s5k5caga(struct tcc_camera_device * vdev)
{
	sensor_port_disable(vdev->gpio_data.rst_port);
	sensor_port_disable(vdev->gpio_data.pwr_port);
	sensor_port_disable(vdev->gpio_data.pwd_port);
...
static int sensor_powerdown_s5k5caga(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	if(bChangeCamera){
...
static int sensor_preview_s5k5caga(struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_common_s5k5caga[1], vdev);
}

static int sensor_capture_s5k5caga(struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_common_s5k5caga[2], vdev);
}

static int sensor_capturecfg_s5k5caga(int width, int height, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_zoom_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_autofocus_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_af_s5k5caga[val], vdev);
}

static int sensor_effect_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_effect_s5k5caga[val], vdev);
}

static int sensor_flip_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_flip_s5k5caga[val], vdev);
}

static int sensor_iso_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_iso_s5k5caga[val], vdev);
}

static int sensor_me_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_metering_exposure_s5k5caga[val], vdev);
}

static int sensor_wb_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_awb_s5k5caga[val], vdev);
}

static int sensor_bright_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_brightness_s5k5caga[val], vdev);
}

static int sensor_scene_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return write_regs_s5k5caga(sensor_reg_scene_s5k5caga[val], vdev);
}

static int sensor_exposure_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	int val2;
	int val3;
	if((val-20)>= 0)
	...
	val2 = (val-20)/val3;
	return write_regs_s5k5caga(sensor_reg_scene_s5k5caga[val2], vdev);
}

static int sensor_check_esd_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_check_luma_s5k5caga(int val, struct tcc_camera_device * vdev)
{
	return 0;
}
...
void sensor_init_fnc_s5k5caga(SENSOR_FUNC_TYPE *sensor_func)
{
	...
	sensor_func->Set_Exposure			= sensor_exposure_s5k5caga; 
...
{
	sensor_info_init_s5k5caga(sensor_info);
}
