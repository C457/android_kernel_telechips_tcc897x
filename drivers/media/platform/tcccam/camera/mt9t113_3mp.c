...
static int write_regs_mt9t113(const struct sensor_reg reglist[], struct tcc_camera_device * vdev)
{
	int err;
	int err_cnt = 0;	
	int sleep_cnt = 100;
...
static int sensor_open_mt9t113(struct tcc_camera_device * vdev, bool bChangeCamera)
{
#if 0
	...
	return write_regs_mt9t113(sensor_reg_common_mt9t113[0], vdev);
}

static int sensor_close_mt9t113(struct tcc_camera_device * vdev)
{
#if 0	
	unsigned char data_r[2];
	unsigned short data_read;
...
static int sensor_powerdown_mt9t113(struct tcc_camera_device * vdev, bool bChangeCamera)
{
#if 0	
	unsigned char data_r[2];
	unsigned short data_read;
...
static int sensor_preview_mt9t113(struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_common_mt9t113[1], vdev);
}

static int sensor_capture_mt9t113(struct tcc_camera_device * vdev)  
{
	return write_regs_mt9t113(sensor_reg_common_mt9t113[2], vdev);
//	return write_regs_mt9t113(sensor_reg_af_mt9t113[0]);
}

static int sensor_capturecfg_mt9t113(int width, int height, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_zoom_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return 0;
}
...
static int sensor_autofocus_mt9t113(int val, struct tcc_camera_device * vdev)  
{
	if(bEnableAutoFocus){
		printk("sensor AutoFocus \n");
		return write_regs_mt9t113(sensor_reg_af_mt9t113[0], vdev);
	}
	else{
		printk("sensor Closeness Focus \n");
		return write_regs_mt9t113(sensor_reg_af_mt9t113[1], vdev);
	}
}

static int sensor_effect_mt9t113(int val, struct tcc_camera_device * vdev)
{		
	return write_regs_mt9t113(sensor_reg_effect_mt9t113[val], vdev);
}

static int sensor_flip_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_flip_mt9t113[val], vdev);
}

static int sensor_iso_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_iso_mt9t113[val], vdev);
}

static int sensor_me_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_metering_exposure_mt9t113[val], vdev);
}

static int sensor_wb_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_awb_mt9t113[val], vdev);
}

static int sensor_bright_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_brightness_mt9t113[val], vdev);
}

static int sensor_scene_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return write_regs_mt9t113(sensor_reg_scene_mt9t113[val], vdev);
}

static int sensor_focus_mode_mt9t113(int val, struct tcc_camera_device * vdev)
{
...
static int sensor_check_esd_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_exposure_mt9t113(int val, struct tcc_camera_device * vdev)
{
	...
	return write_regs_mt9t113(sensor_reg_exposure_mt9t113[val], vdev);
}

static int sensor_check_luma_mt9t113(int val, struct tcc_camera_device * vdev)
{
	return 0;
}
...
{
	sensor_info_init_mt9t113(sensor_info);
}

void sensor_init_fnc_back(SENSOR_FUNC_TYPE *sensor_func)
{
	sensor_init_fnc_mt9t113(sensor_func);
}
