...
static int write_regs_sr130pc10(const struct sensor_reg reglist[], struct tcc_camera_device * vdev)
{
	int err;
	int err_cnt = 0;	
	int sleep_cnt = 100;
...
static int sensor_open_sr130pc10(struct tcc_camera_device * vdev, bool bChangeCamera)
{
	if(bChangeCamera){
	...
	return write_regs_sr130pc10(sensor_reg_common_sr130pc10[0], vdev);
}

static int sensor_close_sr130pc10(struct tcc_camera_device * vdev)
{
	sensor_port_disable(vdev->gpio_data.rst_port);
	sensor_port_disable(vdev->gpio_data.pwr_port);
	sensor_port_disable(vdev->gpio_data.pwd_port);
...
static int sensor_powerdown_sr130pc10(struct tcc_camera_device * vdev, bool bChangeCamera)
{		
...
static int sensor_preview_sr130pc10(struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_common_sr130pc10[1], vdev);
}

static int sensor_capture_sr130pc10(struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_common_sr130pc10[2], vdev);
}

static int sensor_capturecfg_sr130pc10(int width, int height, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_zoom_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_autofocus_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_af_sr130pc10[val], vdev);
}

static int sensor_effect_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_effect_sr130pc10[val], vdev);
}

static int sensor_flip_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_flip_sr130pc10[val], vdev);
}

static int sensor_iso_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_iso_sr130pc10[val], vdev);
}

static int sensor_me_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_metering_exposure_sr130pc10[val], vdev);
}

static int sensor_wb_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_awb_sr130pc10[val], vdev);
}

static int sensor_bright_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_brightness_sr130pc10[val], vdev);
}

static int sensor_scene_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return write_regs_sr130pc10(sensor_reg_scene_sr130pc10[val], vdev);
}
static int sensor_exposure_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	int val2;
	int val3;
	if((val-20)>= 0)
	...
	val2 = (val-20)/val3;
	return write_regs_sr130pc10(sensor_reg_scene_sr130pc10[val2], vdev);
}

static int sensor_check_esd_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return 0;
}

static int sensor_check_luma_sr130pc10(int val, struct tcc_camera_device * vdev)
{
	return 0;
}
...
{
	sensor_info_init_sr130pc10(sensor_info);
}
