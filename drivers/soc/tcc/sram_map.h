...
#define SEC_START	0x8000 /* secondary start address */
//#define SEC_VALID	0x050	/* secondary valid */
#define SEC_VALID	0x8010	/* secondary valid */
#define SUSPENDD    0x070   /* suspend to sram address */
#define RESUMED     0x074   /* resume from sram address */
#define GPIO        0x078   /* gpio repositoy address */

/*
        0xf0000000  ---------------------- 
        (Code)     |  sram boot (w. wfe)  | (0x300)
            0x0300  ----------------------
                   |  sdram init          | (0xD00)
            0x1000  ----------------------
...
#define SRAM_BOOT_SIZE			0x300	/* 0x1E0 */

#define SDRAM_INIT_FUNC_ADDR		(SRAM_CODE_BASE+SRAM_BOOT_SIZE)
...
#define SRAM_RESUME_FUNC_SIZE		0x380	/* 0x19C (0x120:prevent debug) */

#define SRAM_SUSPEND_FUNC_ADDR		(SRAM_RESUME_FUNC_ADDR+SRAM_RESUME_FUNC_SIZE)
#define SRAM_SUSPEND_FUNC_SIZE		0x300	/* 0x1BC (0x1C0:Shutdown) */
...
#define CPUS_CFG_BASE           SRAM_DATA_BASE
#define CPUS_CFG_SIZE           0x30
/* SRAM Data Area */
#define CPU_DATA_REPOSITORY_ADDR	(CPUS_CFG_BASE+CPUS_CFG_SIZE)
...
#define TCC897X_SUSPEND_ADDR		(SRAM_CODE_BASE + SUSPENDD)
