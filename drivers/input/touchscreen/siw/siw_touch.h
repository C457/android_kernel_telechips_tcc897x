...
static inline struct siw_touch_fw_bin *pdata_fw_bin_dis(
                                                                struct siw_touch_pdata *pdata)
{
        return pdata->fw_bin_dis;
}

static inline struct siw_touch_fw_bin *pdata_fw_bin_dis_12_3(
                                                                struct siw_touch_pdata *pdata)
{
...
static inline struct siw_touch_fw_bin *touch_fw_bin_dis(
                                                                struct siw_ts *ts)
{
        return pdata_fw_bin_dis(ts->pdata);
}

static inline struct siw_touch_fw_bin *touch_fw_bin_dis_12_3(
                                                                struct siw_ts *ts)
{
...
extern int des_i2c_bitrate_3gbps_to_6gbps(struct i2c_client *client);
