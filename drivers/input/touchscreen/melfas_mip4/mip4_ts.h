...
#define FW_PATH_INTERNAL_10_25 "melfas/melfas_mip4_ts_10_25.fw"
...
void mip4_serdes_reset_dwork_stop(struct mip4_ts_info *info);
void mip4_serdes_reset_dwork_start(struct mip4_ts_info *info);
