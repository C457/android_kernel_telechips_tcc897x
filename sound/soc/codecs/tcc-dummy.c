...
static struct snd_soc_dai_driver dummy_dai[] = {
	...
	.name = "i2s-dai-dummy",
	.playback = {
		.stream_name = "dummy-i2s-playback",
		.channels_min = 1,
	...
	.name = "IEC958",
	.playback = {
		.stream_name = "dummy-spdif-playback",
		.channels_min = 1,
		#if defined(CONFIG_SND_SOC_TCC_MULTICHANNEL)
		.channels_max = 8,
        .rates    = SNDRV_PCM_RATE_8000_192000,
	...
	.capture = {	// Planet 20130709 S/PDIF_Rx
		.stream_name = "dummy-spdif-capture",
		.channels_min = 1,
		.channels_max = 2,
		.rates    = SNDRV_PCM_RATE_8000_96000,
		.rate_max = 96000,
	...
	.name = "cdif-dai-dummy",
	.capture = {
		.stream_name = "dummy-cdif-playback",
		.channels_min = 1,
        .channels_max = 2,
        .rates    = SNDRV_PCM_RATE_8000_96000,
        .rate_max = 96000,
