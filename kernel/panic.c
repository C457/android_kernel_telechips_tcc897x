...
void panic(const char *fmt, ...)
{
	...
	writel(readl(pmu_reg+PMU_USSTATUS) | KPANIC_PANIC_OCCUR, pmu_reg+PMU_USSTATUS);
	...
	if(tcc_mmc_kpanic_wakeup())
		writel(readl(pmu_reg+PMU_USSTATUS) | KPANIC_WAKEUP_FAIL, pmu_reg+PMU_USSTATUS);
