...
extern unsigned long snapshot_size;
/* Size of required swap partition */
extern unsigned long free_swap_size;
extern unsigned long required_swap_size;
extern unsigned long required_pages(void);
extern int enough_swap(unsigned int nr_pages, unsigned int flags);
extern int swsusp_swap_check(void);

extern int sz_test_enabled;
#endif
